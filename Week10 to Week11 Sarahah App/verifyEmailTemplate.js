  ...
  <style type="text/css">
    @font-face {
      ...
      src: local("apercu-pro"),
        url(https://font.typeform.com/dist/fonts/ApercuPro-Regular.woff2)
          format("woff");
    }
    body,
    td {
...
>
  ...
  >
    <p>
      You’re almost there. Open me up to verify your email—and get back to
      making great typeforms.
    </p>
  </div>
  <table
    border="0"
              ...
              <tr>
                <td style="padding: 30px 30px 20px 0px" class="masthead padded">
                  <a
                    ...
                    id="logo"
                    ><img
                      src="https://s3.amazonaws.com/typeform-marketing-images/logo.png"
                      width="100"
                      alt="t"
                      style="
                        ...
                        border: none;
                      "
                      class="hide_on_mobile" /><!--[if !mso]><!-- --><img
                            ...
                            >
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  >
                                    <p>
                                      Hit the button to verify your email—and
                                      get back to making great typeforms 💪
                                    </p>
                                  </td>
                                </tr>
                                <tr>
                            ...
                            >
                              <tbody>
                                <tr>
                                  ...
                                  >
                                    <p>
                                      This link will self-destruct in 2
                                      hours.<br />
                                      Didn’t ask for this email? Just ignore me.
                                    </p>
                                  </td>
                                </tr>
                              </tbody>
